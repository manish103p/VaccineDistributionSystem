function validateRegistration(){
    ...
    if( document.registerForVaccinationForm.center.value == "-1" ) {
      document.getElementById('signupwarning').innerHTML = "***Please Select Center***";
      document.registerForVaccinationForm.center.focus() ;
      return false;
    }

"""
Django settings for vaccineds project.
...
SECRET_KEY = 'q*c1cyzza-o3jk9i8i#6@+11-*+1%!3$^d(zru1e*rgke0n2#$'
...
WSGI_APPLICATION = 'vaccineds.wsgi.application'
